...
def forwards(apps, schema_editor):
    ...
    # NOTE: Django's default table names keep the AppConfig label casing (e.g. "Prolean_..."),
    # so we always quote table identifiers for PostgreSQL.
    invites = '"Prolean_externallivejoininvite"'
    attempts = '"Prolean_externallivejoinattempt"'
