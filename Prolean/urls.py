...
urlpatterns = [
    ...
    path('external/live/<str:session_id>/mod-state/', views.external_live_mod_state, name='external_live_mod_state'),
    path('external/live/<str:session_id>/security-feed/', views.external_live_security_feed, name='external_live_security_feed'),
    ...
    path('external/live/invite/<str:session_id>/<int:user_id>/regen/', views.external_live_join_invite_regen, name='external_live_join_invite_regen'),
    path('external/live/invite/<str:session_id>/status/', views.external_live_join_invite_status, name='external_live_join_invite_status'),
